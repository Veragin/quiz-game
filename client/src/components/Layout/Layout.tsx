...
interface LayoutProps {
  ...
  /** Room chrome (name, rename, leave) rendered under the title, if any. */
  header?: React.ReactNode;
  /** Wider content for the room screens, which show side-by-side controls. */
  wide?: boolean;
}

export function Layout({ children, header, wide }: LayoutProps) {
  return (
